...
**Is there one page that shows everything that happened on a given day?**
Yes — the Day View. Click any date in the dashboard heatmap or the WOD history calendar, or "View full day" on any workout detail page, and you'll get that day's planned WOD, every workout actually synced, the actual-vs-planned comparison (if the two are linked), your notes, and any personal best achieved — all in one place, with prev/next navigation to browse adjacent days.
