...
- **52-week heatmap** — a full year of training volume at a glance; click any square to see that day's individual workouts, with a link through to that day's full Day View
...
Below your PBs, a **Best Splits** table shows your all-time top 10 fastest single splits by /500m pace, pulled from any interval workout with per-split data. Splits aren't recorded for CSV-imported history, so if you imported past seasons the page tells you how many workouts that excludes rather than just leaving them out quietly.
...
- **Season Challenges** — quarterly targets including distance goals, PB attempts, and consistency streaks, plus a **Challenge History** section showing whether past quarters and months hit their targets
